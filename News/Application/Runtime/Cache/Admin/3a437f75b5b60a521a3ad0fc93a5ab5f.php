                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover cms-table">
                        ...
                        <?php if(is_array($positions)): $i = 0; $__LIST__ = $positions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <span class="news_cursor glyphicon glyphicon-edit editClass1" aria-hidden="true" id="cms-edit" attr-id="<?php echo ($position["id"]); ?>" ></span>
                                    <a class="deleteClass1" href="javascript:void(0)" id="cms-delete"  attr-id="<?php echo ($position["id"]); ?>"  attr-message="删除">
