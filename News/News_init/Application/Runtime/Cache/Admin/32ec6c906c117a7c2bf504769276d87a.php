...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="/News_init/Public/css/bootstrap.min.css" rel="stylesheet">
...
<script src="/News_init/Public/js/jquery.js"></script>
<script src="/News_init/Public/js/dialog/layer.js"></script>
<script src="/News_init/Public/js/dialog.js"></script>
<script src="/News_init/Public/js/admin/login.js"></script>
